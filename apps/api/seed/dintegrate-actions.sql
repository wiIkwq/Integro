...
VALUES
  ('dintegrate-rule-1', 'Правило 1 · 1 монета', '', 1, '/summon superbwarfare:mortar_shell ~2 ~30 ~2',
   ...
   0, 0, 1, '', 'bad', 0,
   1, '2026-05-19T22:05:45.608Z', '2026-05-19T22:05:45.608Z')
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-8', 'Набор ресурсов', '', 40, '/give Bebrok minecraft:iron_ingot 64',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-11', 'Механизм против паразитов (КДУ)', '', 66, '/give Bebrok spore:cdu',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-12', 'Лазерная туррель', '', 70, '/give Bebrok superbwarfare:container{BlockEntityTag:{EntityType:"superbwarfare:laser_tower"}} 1',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-17', 'Мега туррель', '', 99, '/give Bebrok superbwarfare:container{BlockEntityTag:{EntityType:"superbwarfare:waveforce_tower"}} 1',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-18', 'БМП-2', '', 101, '/give Bebrok superbwarfare:container{BlockEntityTag:{EntityType:"superbwarfare:bmp_2"}} 1',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-19', 'Вертолет Mi-28', '', 120, '/give Bebrok superbwarfare:container{BlockEntityTag:{EntityType:"superbwarfare:mi_28"}} 1',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-48', 'Лабораторные блоки', '', 69, '/give Bebrok spore:lab_block 256',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-49', 'Обсидиан', '', 68, '/give Bebrok minecraft:obsidian 256',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-50', 'Ударить молнией всех', '', 111, '/execute at Bebrok at @a run summon minecraft:lightning_bolt',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-54', 'Набор механизмов', '', 154, '/give Bebrok mekanism:basic_smelting_factory',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-55', 'Цифровой шахтер', '', 96, '/give Bebrok mekanismgenerators:wind_generator 4',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-56', 'Танк YX100', '', 142, '/give Bebrok superbwarfare:container{BlockEntityTag:{EntityType:"superbwarfare:yx_100"}} 1',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-57', 'Дроны с гранатами', '', 72, '/give Bebrok superbwarfare:drone 4',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-58', 'Телепортировать всех в шахту', '', 64, '/tp Bebrok ~ -55 ~',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-59', 'Телепортировать все с карты ко мне', '', 362, '/tp @e Bebrok',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-60', 'Лудокейсы', '', 55, '/give Bebrok integrated_lucky_blocks:lucky_block 5',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-61', '100 лудокейсов', '', 500, '/give Bebrok integrated_lucky_blocks:lucky_block 50',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-62', 'Прото разум', '', 305, '/tp Bebrok ~ -50 ~',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-63', 'МЕ система', '', 125, '/give Bebrok refinedstorage:creative_controller',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-71', 'Снаряд миномета в случайного игрока', '', 88, '/execute at Bebrok at @r run summon superbwarfare:mortar_shell ~ ~5 ~',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-73', 'Отравить случайного игрока', '', 45, '/execute at Bebrok at @r run effect give @r minecraft:poison infinite',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-74', 'Отравить всех игроков', '', 175, '/execute at Bebrok at @r run effect give @a minecraft:poison infinite',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-75', 'Задымить всех игроков', '', 36, '/execute at Bebrok at @a run summon superbwarfare:smoke_decoy ~ ~ ~',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-77', 'Супер сильные паразиты на всех', '', 999, '/execute at Bebrok at @a run summon spore:stalker ~1 ~ ~2 {Attributes:[{Name:"minecraft:generic.max_health",Base:250.0}],Health:250.0f,ActiveEffects:[{Id:11b,Amplifier:1b,Duration:999999,ShowParticles:0b}]}',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-79', 'Набор топ туррелей', '', 444, '/give Bebrok superbwarfare:container{BlockEntityTag:{EntityType:"superbwarfare:waveforce_tower"}} 6',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-80', 'ТП всех в лаву под землю', '', 388, '/tp Bebrok ~ -50 ~',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-84', 'ТП в шизокоробку с криперами', '', 888, '/execute at Bebrok run fill ~-5 ~-3 ~-5 ~5 ~3 ~5 minecraft:obsidian hollow',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-92', 'Автоматические фермы железа', '', 51, '/give Bebrok easy_villagers:iron_farm 8',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-93', 'Набор для помощи механизаторам', '', 60, '/give Bebrok mekanism:alloy_infused 128',
...
INSERT INTO minecraft_actions
  (id, title, description, price, command, command_plan, command_mode, repeat_count,
   ...
   is_enabled, created_at, updated_at)
VALUES
  ('dintegrate-rule-99', 'Мега установка против паразитов', '', 313, '/give Bebrok superbwarfare:container{BlockEntityTag:{EntityType:"superbwarfare:annihilator"}} 1',
